...
class AiCache(
    ...
    private val strategy: CacheStrategy = LruCacheStrategy(),
    ...
    fun createTemp(key: CacheKey): String {
    ...
    fun commit(key: CacheKey, tempFilePath: String): String {
    ...
    fun put(key: CacheKey, sourceFilePath: String): String? {
